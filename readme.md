...
|  Result         | Video Logic                 | Audio Logic        |
|-----------------|-----------------------------|--------------------|
| AUTHENTIC HUMAN | Z-Depth > 0.018 + AI < 0.85 | Real Harmonics     |
| DEEPFAKE        | Z-Depth > 0.018 + AI > 0.85 | Synthetic Artifacts|
| CARTOON / PHOTO | Z-Depth < 0.018 (Flat)      | Signal Ignored     |
